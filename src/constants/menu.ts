...
const MENU_ITEMS: MenuItemTypes[] = [
    ...
    { key: 'Call Management', label: 'Call Management', isTitle: true, usershow:["1","2"] },
    {
        key: 'all call',
        label: 'All Conversations',
        isTitle: false,
        icon: 'dripicons-message',
        url: '/all-conversationlist',
        usershow:["1",],
    },
    {
        key: 'todays call',
        ...
        url: '/todays-conversationlist',
        usershow:["1"],
    },
    {
        key: 'todays call',
        label: `Import To Make Call`,
        isTitle: false,
        icon: 'fas fa-upload',
        url: '/importcall-outbound',
        usershow:["1"],
    },
    { key: 'client', label: 'Client Management', isTitle: true, usershow:["0"], },
    {
        key: 'registration',
        label: 'Add client',
        isTitle: false,
    ...
    {
        key: 'calling-subscription',
        label: 'Calling Subscription',
        isTitle: false,
        icon: 'dripicons-view-list',
        usershow:["0"],
        children: [
            ...
            {
                key: 'all-subscription',
                label: 'All Subscription',
                url: '/all-subscription',
                parentKey: 'apps-email',
            },
        ],
    },
