        ...
        },
        {
            ...
            Cell: ({ row }: { row: any }) => (
                ...
                <>
                    <Button
                        variant="primary"
                        onClick={() => handlePlay(row.original._id)}
...
// `${url.nodeapipath}/report/commission`
                ...
                // const response = await fetch(`https://api.plivo.com/v1/Account/${userData.client_authid}/Recording?call_uuid=${call_uuid}`, {
                //     method: 'GET',
                //     headers: {
    ...
    const fetchCallList = async (search?:any) => {
        ...
        try {
            ...
            queryString = `${queryString}client_id=${userData.client_id}&limit=${pagelimit}&offset=${offset}`
            ...
            if(toNumber !== '')
            {
                ...
                // let fromDate = `${todays_Date[0]} 00:00:00`
                // let toDate = `${todays_Date[0]} 23:59:00`

                
                // queryString = `${queryString}&end_time__gte=${fromDate}&end_time__lte=${toDate}`
        ...
        const handleExportPayment = ()=>{
            ...
            exportToExcel(columns,Excelcolumns,data,`Today's Conversion List${(toNumber != '')?`-${toNumber}`:''}.xlsx`)
        }
                ...
                <Card className='' style={{boxShadow: 'none !important'}}>
                    <Card.Body>
                        {/* <div className="d-flex justify-content-between">
                            <div>
                                <h4 className="header-title">Today's Conversation List</h4>
                                <p className="text-muted font-14">A table showing today's conversation list report</p>
                            </div>
                        </div>
                        <hr /> */}
                        <div className="mb-1">
                        ...
                        {(isAudioplayer) &&
                        <>
                        <div className='audio-player-div' onBlur={(e)=>{console.log('Hi')}} ref={boxRef}>
                            {/* <AudioPlayer
                                autoPlay
                                src={audioSrc}
...
export default TodaysConversionList;
