...
import logoDark from '../../assets/images/aiagent-logo.jpeg';
...
const Topbar = ({ openLeftMenuCallBack, containerClass }: TopbarProps) => {
    ...
    return (
        <div className="navbar-custom" style={{backgroundColor:'#e3e9ed'}}>
            <div className={containerClass}>
                <ul className="list-unstyled topnav-menu float-end mb-0">
                    ...
                    <li className="dropdown notification-list topbar-dropdown" >
                        {/* User */}
                        <ProfileDropdown userImage={avatar1} username={(userData !== null)?userData.client_name:''} menuItems={profileMenus} />
                    </li>
                ...
                <div className="logo-box">
                    <Link to="/" className="logo logo-dark text-center">
                        <span className="logo-sm">
                            <img src={''} alt="logo-sm" style={{width:'100%'}} />
                        </span>
                        <span className="logo-lg">
                            {(userData!== null) ?
                            (userData.client_logo !== '')?
                                <img src={`${url.nodeapipath}/images/${userData.client_logo}`} alt="logo-dark" style={{width:'240px',height:'70px'}} />
                                :
                                <div style={{width:'240px',height:'70px'}}>{userData.client_name}</div>:''
                            }
                    ...
                    {/* <Link to="/" className="logo logo-light text-center">
                        <span className="logo-sm">
                            <img src={logoDark} alt="logo-sm" style={{width:'240px'}} />
                        </span>
                        <span className="logo-lg">
                            <img src={logoDark} alt="logo-light" style={{width:'100%'}} />
                        </span>
                    </Link> */}
                </div>
                ...
                <ul className="list-unstyled topnav-menu topnav-menu-left mb-0">
                    ...
                    {layout === LayoutTypes.LAYOUT_VERTICAL && (
                        <li>
                            <h4  style={{color:'#000'}} className="page-title-main">{pageTitle.title}</h4>
                        </li>
                    )}
                </ul>
