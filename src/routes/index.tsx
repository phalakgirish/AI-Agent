...
const ImportClient = React.lazy(() => import('../pages/StaffManagement/ImportClient'));
...
const AllConversationList  = React.lazy(()=> import('../pages/report/AllConversationList'))
const AllConversationHotLeadList  = React.lazy(()=> import('../pages/report/AllConversationHotLeadList'))
const TodaysConversationList  = React.lazy(()=> import('../pages/report/TodaysConversationList'))
const TodaysConversationHotLeadList  = React.lazy(()=> import('../pages/report/TodaysConversationHotLeadList'))
const ImportCallOutBound  = React.lazy(()=> import('../pages/report/importCallOutbound'))


const AddClients = React.lazy(() => import('../pages/StaffManagement/ClientRegistration'));
const AllClients = React.lazy(() => import('../pages/StaffManagement/AllClients'));
const EditClients = React.lazy(() => import('../pages/StaffManagement/EditClient'));
const AllUsers = React.lazy(() => import('../pages/StaffManagement/AllUsers'));
const AllSubscription = React.lazy(() => import('../pages/StaffManagement/AllCallingSubscription'));
const AddSubscription = React.lazy(() => import('../pages/StaffManagement/AddCallingSubscription'));
const EditSubscription = React.lazy(() => import('../pages/StaffManagement/EditCallingSubscription'));
  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'edit-client/:id',
          element: <LoadComponent component={EditClients} />,
        },
        {
          path: 'add-subscription',
          element: <LoadComponent component={AddSubscription} />,
        },
        {
          path: 'all-subscription',
          element: <LoadComponent component={AllSubscription} />,
        },
        {
          path: 'edit-subscription/:id',
          element: <LoadComponent component={EditSubscription} />,
        },
        {
          path: 'all-conversationlist',
          element: <LoadComponent component={AllConversationList} />,
        },
        {
          path: 'all-conversationhotlist',
          element: <LoadComponent component={AllConversationHotLeadList} />,
        },
        {
          path: 'todays-conversationlist',
          element: <LoadComponent component={TodaysConversationList} />,
        },
        {
          path: 'todays-conversationhotlist',
          element: <LoadComponent component={TodaysConversationHotLeadList} />,
        },
        
        {
          path: 'importcall-outbound',
          element: <LoadComponent component={ImportCallOutBound} />,
        },
        {
          path: 'users',
